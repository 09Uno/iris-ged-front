...
@Component({
  ...
  templateUrl: './inserir-arquivos-processos.component.html',
  styleUrl: './inserir-arquivos-processos.component.scss',
})
export class InserirArquivosProcessosComponent {
